...
# seq_root = './{}/images/test'.format(MOT_data)
# label_root = './{}/labels_with_ids/test'.format(MOT_data)

seq_roots = ['./{}/images/train'.format(MOT_data), './{}/images/test'.format(MOT_data)]
label_roots = ['./{}/labels_with_ids/train'.format(MOT_data), './{}/labels_with_ids/test'.format(MOT_data)]

for seq_root, label_root in zip(seq_roots, label_roots):
    # seq_root = seq_roots[i]
